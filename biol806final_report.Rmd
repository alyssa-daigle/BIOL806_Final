...
![Map of the sampling locations in Durham, NH.]("sampling_locations.png"){width=85%}
...
```{r avg plate comp figure, fig.cap = "The average percent coverage for each microbe color at each location.", echo=FALSE, include=TRUE}
avg_plate_fig
```
...
```{r line plot all colors figure, fig.cap = "Line plot showing the percent coverage of each color over time at each location on the Left or Right side.", echo=FALSE, include=TRUE}
line_grid_plot
```
